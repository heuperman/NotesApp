...
function testreturnHTML() {
  ...
  notelist.newNote("twentycharactersasdxdsasretcarahcytnewt")
  var noteListView = new NoteListView(notelist)
  assert.isTrue(noteListView.returnHTML() === '<ul><li><div><a href="http://localhost:8080#notes/0">twentycharactersasdx</a></div></li><li><div><a href="http://localhost:8080#notes/1">twentycharactersasdx</a></div></li></ul>')
};
